...
const Header = ({setListImages, setIsLoading}) =>{
    ...
    return (
        ...
        <div className="container mx-auto max-w-5xl px-2 py-6">
            { /* Logo */}
            <p className="block font-bold text-xl font-opensans">Text2<span
            className="text-primary">Pic</span></p>
            {/* Tagline */}
            <div className="mt-14">
                ...
                <form className="relative my-8 max-w-md" onSubmit={handleSubmit}>
                    <input value={inputValue} onChange={handleInputChange} className="indent-2 py-4 pr-[4.5rem] rounded-sm bg-grey-50 w-full md:max-w-md focus:ring-primary outline-none focus:ring-1" type="text" placeholder="Unleash the power of AI to create" />
